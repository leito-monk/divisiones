...
Simplemente haz doble clic en `index.html` o abre el archivo en tu navegador favorito.
...
### 🎯 Parámetro de URL: Selección Automática de Personaje
...
Creado con ❤️ para aprender divisiones de forma divertida
